(function () {
  ...
  function enhanceServiceGalleryFlow() {
    ...
    if(!document.getElementById("gallery-service-actions-style")){
      ...
      style.textContent=".gallery-service-actions{display:flex;justify-content:center;gap:12px;flex-wrap:wrap;margin:28px auto 4px;padding:18px 20px;border-radius:22px;background:linear-gradient(135deg,#f4eafb 0%,#fff1f8 50%,#eefbfb 100%);box-shadow:0 10px 24px rgba(65,22,91,.10)}.gallery-service-actions a{display:inline-flex;align-items:center;justify-content:center;min-width:170px;padding:11px 18px;border-radius:999px;text-decoration:none;font-size:14px;font-weight:900;box-sizing:border-box}.gallery-back-services{border:2px solid #4e1979;background:#fff;color:#4e1979}.gallery-back-services:hover{background:#f5ecfb}.gallery-book-service{border:2px solid #f51b9a;background:#f51b9a;color:#fff;box-shadow:0 6px 16px rgba(245,27,154,.20)}.gallery-book-service:hover{filter:brightness(.96)}@media(max-width:520px){.gallery-service-actions{gap:9px;margin-top:22px;padding:16px 12px}.gallery-service-actions a{width:100%;max-width:310px;min-width:0;padding:12px 16px;font-size:14px}}";
      document.head.appendChild(style);
    }
    var backLinks={
