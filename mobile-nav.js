(function () {
  ...
  function enhanceTrustSection() {
    ...
    style.textContent = [
      ...
      "@media(max-width:420px){.home-theme .brand-name{font-size:43px!important}.home-theme .brandmark:after{font-size:10px;right:0;top:-7px}.home-theme .hero-copy h1{font-size:clamp(34px,9.9vw,43px)!important;letter-spacing:-.045em!important}.home-theme .hero-copy h1 strong{font-size:1.07em!important}.home-theme .celebrate p{font-size:12.5px!important;letter-spacing:.025em!important;width:calc(100% - 30px)!important}.home-theme .hero-photo img{max-width:min(86vw,320px)!important}}"
    ].join("");
