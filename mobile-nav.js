(function () {
  ...
  function enhanceTrustSection() {
    ...
    style.textContent = [
      ...
      "@media(max-width:700px){.home-theme .trust-section{margin:0 12px 24px;padding:20px 12px}.home-theme .trust-section h2{font-size:27px}.home-theme .trust-item{min-height:128px;padding:18px 10px 15px!important}.home-theme .trust-item:before{width:42px;height:42px;font-size:21px;margin-bottom:9px}}"
    ].join("");
